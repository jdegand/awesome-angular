...
* [Namiru.ai](https://namiru.ai/) - Add AI Chat to your website using a simple script tag or [Angular NPM package](https://www.npmjs.com/package/@namiruai/angular).
...
* [fslightbox-angular](https://github.com/banthagroup/fslightbox-angular) - The Angular version of [Fullscreen Lightbox](https://fslightbox.com/).
