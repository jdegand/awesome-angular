...
* [aeo.js](https://github.com/multivmlabs/aeo.js) - Generates the metadata AI engines rely on and includes a drop‑in widget that previews how your site appears to them.
