...
* [dayflow-js](https://github.com/dayflow-js/calendar) - A flexible and feature-rich calendar component library for React, Vue, Angular, and Svelte with drag-and-drop support, multiple views, and plugin architecture.
