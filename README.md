...
* [lin](https://github.com/yuo-app/lin) - A CLI tool that translates locale JSONs using LLMs.
...
* [ng-ssr-caching](https://github.com/nigrosimone/ng-ssr-caching) - Cache for server-side rendered pages in Angular SSR.
...
* [Official Angular Examples Repo](https://github.com/angular/examples) - Angular Examples using [GenKit](https://firebase.google.com/docs/genkit) and AI.
...
* [visual-ai-editor](https://github.com/bruno-gs-dev/visual-ai-editor) - Edit existing HTML with AI using natural language.
...
* [clickstream-analytics-on-aws-web-sdk](https://github.com/aws-solutions/clickstream-analytics-on-aws-web-sdk) - Enables collection of browser clickstream data to AWS via the provided data pipeline.
...
* [litlyx](https://github.com/Litlyx/litlyx) - An open-source analytics tool — set up with one line of code.
...
* [bundleradar](https://github.com/sonuKumar03/bundleradar) - Lightning-fast bundle inspector, dependency tracer, optimization advisor, and CI budget gate for Angular esbuild.
...
* [ng-loom](https://github.com/xonaib/ng-loom) - A CLI that scans an Angular project and emits a shareable, self-contained static HTML report of the app's architecture: components, directives, pipes, services, wrappers, imports, and injections.
...
* [spiderly](https://github.com/filiptrivan/spiderly) - A `.NET` (C#) generator that turns your EF Core model into a customizable `.NET` and Angular app.
...
* [Angular Translation Extractor](https://github.com/devremoto/angular-translation-extractor) - [VS Code extension](https://marketplace.visualstudio.com/items?itemName=AdilsondeAlmeidaPedro.angular-translation-extractor) that extracts, auto-translates, and manages `ngx-translate` keys and assets for Angular apps.
...
* [transloco-keys-manager](https://github.com/jsverse/transloco/tree/master/libs/transloco-keys-manager) - Extract translatable keys from projects that use Transloco.
...
* [Super JSS](https://github.com/rsantoyo-dev/super-jss-workspace) - A tiny Angular runtime library that generates atomic CSS with breakpoints and theming.
...
* [msal-angular](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/lib/msal-angular) - Authenticates users via Microsoft or social accounts and acquires tokens for secure Microsoft services like [Graph](https://developer.microsoft.com/en-us/graph).
...
* [ngx-auth-client](https://github.com/ismailza/ngx-auth-client) - Angular authentication layer providing signal-based state management, functional route protection, and Keycloak integration.
...
* [supply-chain-inspector](https://github.com/DenysVuika/supply-chain-inspector) - A standalone, zero-dependency Node.js script for supply chain security analysis of npm dependencies.
...
* [angular-ngrx-nx-realworld-example-app](https://github.com/stefanoslig/angular-ngrx-nx-realworld-example-app) - Real world application built with Angular 21, NgRx 21, and Nx 22.
...
* [swc-angular-plugin](https://github.com/jscutlery/devkit/tree/main/packages/swc-angular-plugin) - An SWC plugin that adds Angular support to the lightning-fast JavaScript/TypeScript compiler.
...
* [ngtx](https://github.com/Centigrade/ngtx) - A small set of functions that make your life easier when testing Angular components.
...
* [ngx-testbox](https://github.com/kirill-kolomin/ngx-testbox) - A comprehensive Angular testing library that simplifies and secures unit, integration, and E2E tests.
...
* [coreui-free-angular-admin-template](https://github.com/coreui/coreui-free-angular-admin-template) - Admin template based on Bootstrap 5.
...
* [material-pro-angular-lite](https://github.com/wrappixel/material-pro-angular-lite) - A high-quality Angular Material theme from WrapPixel, free for both personal and commercial projects.
* [spike-angular-free](https://github.com/wrappixel/spike-angular-free) - The most powerful & comprehensive free Angular admin template based on Material Angular.
...
* [berry-free-angular-admin-template](https://github.com/codedthemes/berry-free-angular-admin-template) - A free Angular + Bootstrap 5 admin dashboard with customizable, feature-rich pages for optimal UX.
...
* [realworld-angular](https://github.com/realworld-angular/realworld-angular) - Real world Angular example apps showcasing Angular libraries in action.
...
* [web-scrolling-text](https://github.com/mehardiknaik/web-scrolling-text) - A lightweight, customizable text animation library for creating smooth scrolling text effects with support for React, Next.js, Angular, and Vanilla JavaScript.
...
* [impler](https://github.com/implerhq/impler.io) - Use the [Angular package](https://www.npmjs.com/package/@impler/angular) to embed the CSV Excel Importer into your app.
...
* [ZingGrid](https://github.com/ZingGrid/zinggrid) - A JavaScript Web Component that integrates seamlessly with [Angular](https://www.zinggrid.com/docs/integrations/js-frameworks-&-libs/angular) and many other frameworks.
* [ngx-panemu-table](https://github.com/panemu/ngx-panemu-table) - An easy-to-use Angular table component configured primarily in TypeScript, requiring only a simple `panemu-table` tag in your HTML.
...
* [ng-lock](https://github.com/nigrosimone/ng-lock) - Angular decorator to lock a function and user interface while a task is running.
...
* [ngx-simple-text-editor](https://github.com/Raiper34/ngx-simple-text-editor) - A simple native text editor component for Angular 9+.
...
* [ng-select2](https://github.com/Harvest-Dev/ng-select2) - An updated fork of [select2-component](https://github.com/plantain-00/select2-component).
...
* [validointi](https://github.com/validointi/validointi) - A library to help you validate your template driven forms.
...
* [ngx-form-validation](https://github.com/such-code/ngx-workspace/blob/main/projects/ngx-form-validation/README.md) - This library adds reactive-style validation to template-driven forms.
...
* [angular-line-awesome](https://github.com/marco-martins/angular-line-awesome) - An Angular component to manage [Line Awesome](https://icons8.com/line-awesome) icons.
...
* [@jjmhalew/ngx-lightbox](https://github.com/jjmhalew/ngx-lightbox) - A [lightbox2](https://github.com/lokesh/lightbox2) implementation port to use with Angular >= 18 (zoneless).
* [@necraidan/ngx-lightbox](https://github.com/necraidan/ngx-lightbox) - A lightweight, accessible Angular 21+ lightbox with zoom, pan, pinch‑to‑zoom, and keyboard navigation, all with zero dependencies.
...
* [ng-smart-images](https://github.com/yadimon/ng-smart-images) - CLI-first image optimization with hashed assets, runtime manifests, and optional Angular helpers.
...
* [angular-smart-skeleton](https://github.com/Nikmakwana94/angular-smart-skeleton) - A flexible and reusable Angular skeleton loader for dynamic rows, columns, cards, lists, tables, and custom layouts.
...
* [phantom-ui](https://github.com/Aejkatappaja/phantom-ui) - Structure-aware skeleton loader. One Web Component. Every framework.
...
* [shimmerkit](https://github.com/Eswar2000/shimmerkit) - Zero-dependency, framework-agnostic animated loaders & skeleton placeholders.
...
* [ssv.ngx](https://github.com/sketch7/ssv.ngx) - Mono-repo of libraries from [sketch7](https://github.com/sketch7) including [ngx.command](https://github.com/sketch7/ssv.ngx/tree/master/libs/ngx.command#readme) and [ngx.ux](https://github.com/sketch7/ssv.ngx/blob/master/libs/ngx.ux/README.md).
...
* [@everllence/ngx-tools](https://github.com/everllence/ngx-tools) - A collection of libraries designed to elevate your Angular development experience.
...
* [ssgoi](https://github.com/meursyphus/ssgoi) - Animates the change between routes without taking over navigation.
...
* [fundamental-ngx](https://github.com/SAP/fundamental-ngx) - SAP design system Angular component library.
* [designsystem](https://github.com/kirbydesign/designsystem) - UX Component library implementing the Kirby Design Philosophy.
...
* [antwerp-ui_angular](https://github.com/digipolisantwerp/antwerp-ui_angular) - A component interface library for building user interfaces and responsive web apps.
* [ng-clarity](https://github.com/vmware-clarity/ng-clarity) - A scalable, accessible, customizable, open-source design system built for Angular.
...
* [IgniteUI Angular](https://github.com/IgniteUI/igniteui-angular) - A complete library of Angular-native, Material-based Angular UI components with the fastest grids, charts, and more.
...
* [Preline UI](https://github.com/htmlstreamofficial/preline) - An open-source set of prebuilt UI components based on the Tailwind CSS framework.
...
* [aria-ng-ui](https://github.com/phalla-doll/aria-ng-ui) - A modern, accessible Angular component library inspired by `shadcn/ui` — built with Angular-native patterns, Tailwind CSS, and accessibility-first primitives.
...
* [levita](https://github.com/Jeromearsene/levita) - Lightweight 3D tilt & parallax with accelerometer support.
...
* [wolf-tui](https://github.com/OneEyed1366/wolf-tui) - Write CLI apps with your web framework — React, Vue, Angular, Solid, or Svelte.
...
* [atlas-editor](https://github.com/sumanthnagireddi/atlas-editor) - Angular wrappers that dynamically load the React‑based Atlaskit editor and side‑navigation web components.
